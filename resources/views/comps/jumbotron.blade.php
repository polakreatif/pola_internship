<div id="hero" class="d-flex align-items-center">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pt-5 order-2 order-lg-1">
        ...
        @endif
        <a href="#about" class="btn-get-started scrollto" data-aos="zoom-in" data-aos-delay="200">Pesan Jasa</a>
      </div>
      <div class="col-lg-6 order-1 order-lg-2 hero-img">
        ...
        @if(strlen($jumbotron->sumber_link) > 0)
          <div class="d-flex justify-content-end" data-aos="zoom-in" data-aos-delay="100">
