                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit</strong> Jumbotron
                                    </div>
                                    <div class="card-body card-block">
                                        {!! Form::open(['action' => ['Admin\JumbotronController@update', $jumbotrons->id_jumbo], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                            <div class="form-group">
                                                {{ Form::label('header',  'Header Jumbotron') }}
                                                {{ Form::text('header', $jumbotrons->header, ['class' => 'form-control', 'placeholder' => 'Masukkan header jumbotron', 'autocomplete' => 'off']) }}
                                            </div>
                                            <div class="form-group">
                                                {{ Form::label('konten',  'Isi Jumbotron') }}
                                                {{ Form::textarea('konten', $jumbotrons->konten, ['id' => 'konten', 'class' => 'form-control', 'placeholder' => 'Masukkan isi artikel']) }}
                                            </div>
                                            <div class="form-group">
                                                {{ Form::label('link',  'Link Jumbotron') }}
                                                {{ Form::url('link', $jumbotrons->link, ['class' => 'form-control', 'placeholder' => 'Masukkan isi artikel']) }}
                                            </div>
                                            <div class="form-group">
