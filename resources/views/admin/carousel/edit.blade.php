            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Caraousel</h2>
                                @if(count($errors) > 0)
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit</strong> Carousel
                                    </div>
                                    <div class="card-body card-block">
                                        {!! Form::open(['action' => ['Admin\CarouselController@update', $carousels->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                            <div class="form-group">
                                                {{ Form::label('nama',  'Nama Carousel') }}
                                                {{ Form::text('nama', $carousels->nama, ['class' => 'form-control', 'placeholder' => 'Masukkan nama carousel', 'autocomplete' => 'off']) }}
                                            </div>
                                            <div class="form-group">
