                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        {!! Form::open(['action' => 'Admin\ArticleController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                            <div class="form-group">
                                                {{ Form::label('judul',  'Judul Artikel') }}
                                                {{ Form::text('judul', '', ['class' => 'form-control', 'placeholder' => 'Masukkan judul artikel', 'autocomplete' => 'off']) }}
                                            </div>
                                            <div class="form-group">
