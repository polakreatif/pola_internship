                                    ...
                                    <div class="card-body card-block">
                                        {!! Form::open(['action' => 'Admin\ProductController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                            <div class="form-group">
                                                ...
                                                {{ Form::text('nama', '', ['class' => 'form-control', 'placeholder' => 'Masukkan nama produk', 'autocomplete' => 'off']) }}
                                            </div>
                                            <div class="form-group">
                                                {{ Form::label('deskripsi',  'Deskripsi Produk') }}
                                                {{ Form::textarea('deskripsi', '', ['id' => 'konten', 'class' => 'form-control', 'placeholder' => 'Masukkan deskripsi product']) }}
                                            </div>
                                            <div class="form-group">
                                                {{ Form::label('product_image',  'Gambar Product') }}<br>
